...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/intelligence/learning', destination: '/intelligence?tab=continuous-learning', permanent: false },
      { source: '/intelligence/promotion', destination: '/intelligence?tab=promotion', permanent: false },
      { source: '/intelligence/counterfactual', destination: '/intelligence?tab=counterfactual', permanent: false },
