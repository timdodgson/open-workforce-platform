...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/getting-started`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${BASE_URL}/algorithms`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.88 },
    { url: `${BASE_URL}/domains`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.88 },
    { url: `${BASE_URL}/references`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
