...
const LEARNING_PATH = [
  ...
  },
  {
    ...
    time: '~2 hours',
    steps: [
      'Clone repo, install Go — or follow /getting-started Quick start first',
  ...
  },
  {
    ...
    time: 'Half day',
    steps: [
      'Run SA, LAHC, Tabu, GA, and Portfolio on one instance (--worker-decision-mode off)',
      'Record gap-to-optimal for each mode',
      'Use /benchmarks reproduce hints or docs/06-engineering/benchmark-suite.md',
      'Optional: start from /getting-started Quick start if you have not run the CLI yet',
    ],
